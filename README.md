...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/frosty-recipe-3efd)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-recipe-3efd
```

A live public deployment of this template is available at [https://frosty-recipe-3efd.templates.workers.dev](https://frosty-recipe-3efd.templates.workers.dev)
